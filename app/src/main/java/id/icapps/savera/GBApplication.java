...
import id.icapps.savera.database.DBOpenHelper;
...
import id.icapps.savera.entities.DaoMaster;
import id.icapps.savera.entities.DaoSession;
import id.icapps.savera.entities.Device;
import id.icapps.savera.externalevents.BluetoothStateChangeReceiver;
import id.icapps.savera.externalevents.opentracks.OpenTracksContentObserver;
...
import id.icapps.savera.service.NotificationCollectorMonitorService;
...
import id.icapps.savera.util.PendingIntentUtils;
import id.icapps.savera.util.Prefs;
import id.icapps.savera.util.preferences.DevicePrefs;

import static id.icapps.savera.model.DeviceType.AMAZFITBIP;
import static id.icapps.savera.model.DeviceType.AMAZFITCOR;
import static id.icapps.savera.model.DeviceType.AMAZFITCOR2;
import static id.icapps.savera.model.DeviceType.FITPRO;
import static id.icapps.savera.model.DeviceType.GALAXY_BUDS;
import static id.icapps.savera.model.DeviceType.LEFUN;
import static id.icapps.savera.model.DeviceType.MIBAND;
import static id.icapps.savera.model.DeviceType.MIBAND2;
import static id.icapps.savera.model.DeviceType.MIBAND2_HRX;
import static id.icapps.savera.model.DeviceType.MIBAND3;
import static id.icapps.savera.model.DeviceType.PEBBLE;
import static id.icapps.savera.model.DeviceType.TLW64;
import static id.icapps.savera.model.DeviceType.WATCHXPLUS;
import static id.icapps.savera.util.GB.NOTIFICATION_CHANNEL_HIGH_PRIORITY_ID;
import static id.icapps.savera.util.GB.NOTIFICATION_ID_ERROR;
...
public class GBApplication extends Application {
    ...
    public static final String DATABASE_NAME = "Saverawatch";
    ...
    public static final String ACTION_QUIT
            = "id.icapps.savera.gbapplication.action.quit";
    public static final String ACTION_LANGUAGE_CHANGE = "id.icapps.savera.gbapplication.action.language_change";
    public static final String ACTION_THEME_CHANGE = "id.icapps.savera.gbapplication.action.theme_change";
    public static final String ACTION_NEW_DATA = "id.icapps.savera.action.new_data";
    ...
    public static void quit() {
        GB.log("Quitting Saverawatch...", GB.INFO, null);
    ...
    public static void restart() {
        GB.log("Restarting Saverawatch...", GB.INFO, null);
    ...
    private void migratePrefs(int oldVersion) {
        ...
        if (oldVersion < 6) {
            ...
            migrateStringPrefToPerDevicePref("mi_button_press_broadcast", "id.icapps.savera.ButtonPressed", "button_action_broadcast", new ArrayList<>(Collections.singletonList(MIBAND2)));
        }
        if (oldVersion < 7) {
    ...
    public String getVersion() {
        try {
            ...
            GB.log("Unable to determine Saverawatch's version", GB.WARN, e);
            return "0.0.0";
        }
    }
    ...
    public String getNameAndVersion() {
        try {
            ...
            GB.log("Unable to determine Saverawatch's name/version", GB.WARN, e);
            return "Saverawatch";
        }
    }
