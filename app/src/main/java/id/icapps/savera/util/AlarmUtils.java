...
public class AlarmUtils {
     ...
     * @return
     */
    public static id.icapps.savera.model.Alarm createSingleShot(int index, boolean smartWakeup, boolean snooze, Calendar calendar) {
     ...
     * @return
     */
    public static Calendar toCalendar(id.icapps.savera.model.Alarm alarm) {
