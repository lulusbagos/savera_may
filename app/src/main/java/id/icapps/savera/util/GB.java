...
import static id.icapps.savera.GBApplication.isRunningOreoOrLater;
import static id.icapps.savera.model.DeviceService.EXTRA_RECORDED_DATA_TYPES;
...
import id.icapps.savera.GBEnvironment;
...
public class GB {
    public static final String ACTION_ACTIVITY_SYNC = "id.icapps.savera.action.ACTIVITY_SYNC_FINISH";

    public static final String NOTIFICATION_CHANNEL_ID = "saverawatch";
    public static final String NOTIFICATION_CHANNEL_ID_CONNECTION_STATUS = "saverawatch connection status";
    ...
    public static final String NOTIFICATION_CHANNEL_ID_TRANSFER = "saverawatch transfer";
    ...
    public static final int NOTIFICATION_ID_UPLOAD_FAILED = 43;
    ...
    public static Notification createUploadFailedNotification(String text, Context context) {
        Intent notificationIntent = new Intent(context, ControlCenterv2.class);
        notificationIntent.setPackage(BuildConfig.APPLICATION_ID);
        notificationIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK
                | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        ...
        NotificationCompat.Builder nb = new NotificationCompat.Builder(context, NOTIFICATION_CHANNEL_HIGH_PRIORITY_ID)
                .setContentTitle("Sinkronisasi data tertunda")
                .setContentText(text)
                .setStyle(new NotificationCompat.BigTextStyle().bigText(text))
                .setTicker(text)
                .setContentIntent(pendingIntent)
    ...
    public static void updateUploadFailedNotification(String text, Context context) {
        ...
        notify(NOTIFICATION_ID_UPLOAD_FAILED, notification, context);
    }
