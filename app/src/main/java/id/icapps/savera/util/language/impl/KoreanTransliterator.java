...
package id.icapps.savera.util.language.impl;
...
public class KoreanTransliterator implements Transliterator {
    ...
    private static char decompatJamo(char jamo) {
        ...
        if (!inRange(jamo, COMPAT_JAMO_BLOCK_START, COMPAT_JAMO_BLOCK_END)) {
            return jamo;
        }
    ...
    public static Optional<String> transliterateSpecialProvisions(char previousEnding, char nextInitial) {
        ...
        if (!inRange(previousEnding, JAMO_BLOCK_START, JAMO_BLOCK_END)) {
            return Optional.empty();
        }
        if (!inRange(nextInitial, JAMO_BLOCK_START, JAMO_BLOCK_END)) {
            return Optional.empty();
        }
        ...
        if (previousEnding == 0x11C2) { // ㅎ
            switch (nextInitial) {
                case 0x110B:
                    return Optional.of("h");       // ㅇ
                case 0x1100:
                    return Optional.of("k");       // ㄱ
                case 0x1102:
                    return Optional.of("nn");      // ㄴ
                case 0x1103:
                    return Optional.of("t");       // ㄷ
                case 0x1105:
                    return Optional.of("nn");      // ㄹ
                case 0x1106:
                    return Optional.of("nm");      // ㅁ
                case 0x1107:
                    return Optional.of("p");       // ㅂ
                case 0x1109:
                    return Optional.of("hs");      // ㅅ
                case 0x110C:
                    return Optional.of("ch");      // ㅈ
                case 0x1112:
                    return Optional.of("t");       // ㅎ
                default:
                    return Optional.empty();
            }
        }
        ...
        switch (nextInitial) {
            ...
            case 0x1102: // ㄴ
                switch (previousEnding) {
                    ...
                    case 0x11AF:
                        return Optional.of("ll");  // ㄹ
                    case 0x11B8:
                        return Optional.of("mn");  // ㅂ
                    default:
                        return Optional.empty();
                }
            case 0x1105: // ㄹ
            ...
            case 0x110B: // ㅇ
                switch (previousEnding) {
                    case 0x11A8:
                        return Optional.of("g");   // ㄱ
                    case 0x11AE:
                        return Optional.of("d");   // ㄷ
                    case 0x11AF:
                        return Optional.of("r");   // ㄹ
                    case 0x11B8:
                        return Optional.of("b");   // ㅂ
                    case 0x11BA:
                        return Optional.of("s");   // ㅅ
                    case 0x11BC:
                        return Optional.of("ng-"); // ㅇ
                    case 0x11BD:
                        return Optional.of("j");   // ㅈ
                    case 0x11BE:
                        return Optional.of("ch");  // ㅊ
                    default:
                        return Optional.empty();
                }
            case 0x110F: // ㅋ
