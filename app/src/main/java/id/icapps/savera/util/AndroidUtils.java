    ...
    public static String getTextColorHex(Context context) {
        ...
        if (DynamicColors.isDynamicColorAvailable() && GBApplication.areDynamicColorsEnabled()) {
            ...
            if (GBApplication.isDarkThemeEnabled()) {
                dynamicColorContext = DynamicColors.wrapContextIfAvailable(context, R.style.SaveraUiThemeDynamicDark);
            } else {
                dynamicColorContext = DynamicColors.wrapContextIfAvailable(context, R.style.SaveraUiThemeDynamicLight);
            }
