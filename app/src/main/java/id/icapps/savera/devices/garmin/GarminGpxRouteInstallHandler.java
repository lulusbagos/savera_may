...
import id.icapps.savera.service.devices.garmin.fit.GpxRouteFileConverter;
import id.icapps.savera.util.FileUtils;
import id.icapps.savera.util.UriHelper;

import static id.icapps.savera.devices.vivomovehr.GarminCapability.COURSE_DOWNLOAD;
