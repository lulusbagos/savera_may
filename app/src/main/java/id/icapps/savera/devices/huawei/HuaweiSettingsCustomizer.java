...
import id.icapps.savera.service.devices.huawei.HuaweiWorkoutGbParser;
import id.icapps.savera.util.GB;
import id.icapps.savera.util.Prefs;
import id.icapps.savera.util.XTimePreference;

import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.*;
import static id.icapps.savera.devices.huawei.HuaweiConstants.PREF_HUAWEI_DEBUG_REQUEST;
import static id.icapps.savera.devices.huawei.HuaweiConstants.PREF_HUAWEI_CONTINUOUS_SKIN_TEMPERATURE_MEASUREMENT;
import static id.icapps.savera.devices.huawei.HuaweiConstants.PREF_HUAWEI_TRUSLEEP;
import static id.icapps.savera.devices.huawei.HuaweiConstants.PREF_HUAWEI_WORKMODE;
