...
package id.icapps.savera.devices.test;
...
import id.icapps.savera.capabilities.widgets.WidgetManager;
import id.icapps.savera.devices.AbstractDeviceCoordinator;
...
import id.icapps.savera.devices.roidmi.RoidmiConst;
import id.icapps.savera.devices.test.activity.TestActivitySummaryParser;
import id.icapps.savera.devices.test.samples.TestBodyEnergySampleProvider;
import id.icapps.savera.devices.test.samples.TestHrvSummarySampleProvider;
import id.icapps.savera.devices.test.samples.TestHrvValueSampleProvider;
import id.icapps.savera.devices.test.samples.TestPaiSampleProvider;
import id.icapps.savera.devices.test.samples.TestRespiratoryRateSampleProvider;
import id.icapps.savera.devices.test.samples.TestSpo2SampleProvider;
import id.icapps.savera.devices.test.samples.TestStressSampleProvider;
import id.icapps.savera.devices.test.samples.TestSampleProvider;
import id.icapps.savera.devices.test.samples.TestTemperatureSampleProvider;
...
import id.icapps.savera.model.AbstractNotificationPattern;
...
import id.icapps.savera.model.PaiSample;
...
import id.icapps.savera.model.TemperatureSample;
import id.icapps.savera.service.DeviceSupport;
import id.icapps.savera.service.ServiceDeviceSupport;
import id.icapps.savera.service.devices.test.TestDeviceSupport;
