...
package id.icapps.savera.devices.huawei;

import static id.icapps.savera.devices.huawei.HuaweiConstants.HUAWEI_MAGIC;
...
import id.icapps.savera.devices.huawei.packets.Alarms;
...
import id.icapps.savera.devices.huawei.packets.Contacts;
import id.icapps.savera.devices.huawei.packets.EphemerisFileUpload;
import id.icapps.savera.devices.huawei.packets.FileDownloadService0A;
import id.icapps.savera.devices.huawei.packets.FileDownloadService2C;
...
import id.icapps.savera.devices.huawei.packets.Notifications;
