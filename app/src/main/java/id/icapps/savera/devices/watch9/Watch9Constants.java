...
package id.icapps.savera.devices.watch9;
...
public final class Watch9Constants {
    ...
    public static final String ACTION_CALIBRATION
            = "id.icapps.savera.devices.action.watch9.start_calibration";
    public static final String ACTION_CALIBRATION_SEND
            = "id.icapps.savera.devices.action.watch9.send_calibration";
    public static final String ACTION_CALIBRATION_HOLD
            = "id.icapps.savera.devices.action.watch9.keep_calibrating";
