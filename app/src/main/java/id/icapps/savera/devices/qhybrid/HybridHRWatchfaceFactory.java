...
import id.icapps.savera.service.devices.qhybrid.requests.fossil_hr.image.ImageConverter;
...
public class HybridHRWatchfaceFactory {
    ...
    public byte[] getWapp(Context context) throws IOException {
        ...
        try {
            ...
            if (includeWidget("widgetCustom") > 0)
                icons.put("widget_bg_error.rle", context.getAssets().open("fossil_hr/widget_bg_error.rle"));
