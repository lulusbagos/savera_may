...
package id.icapps.savera.devices.lenovo;
...
public class LenovoWatchConstants {
    ...
    public static final String ACTION_CALIBRATION
            = "id.icapps.savera.devices.action.lenovowatch.start_calibration";
    public static final String ACTION_CALIBRATION_SEND
            = "id.icapps.savera.devices.action.lenovowatch.send_calibration";
    public static final String ACTION_CALIBRATION_HOLD
            = "id.icapps.savera.devices.action.lenovowatch.keep_calibrating";
