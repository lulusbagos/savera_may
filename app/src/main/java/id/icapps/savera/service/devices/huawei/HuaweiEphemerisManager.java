...
import id.icapps.savera.service.devices.huawei.requests.SendEphemerisDataRequestResponse;
import id.icapps.savera.service.devices.huawei.requests.SendEphemerisFileConsultResponse;
import id.icapps.savera.service.devices.huawei.requests.SendEphemerisFileListResponse;
import id.icapps.savera.service.devices.huawei.requests.SendEphemerisFileStatusRequest;
import id.icapps.savera.service.devices.huawei.requests.SendEphemerisFileUploadChunk;
import id.icapps.savera.service.devices.huawei.requests.SendEphemerisFileUploadDoneResponse;
import id.icapps.savera.service.devices.huawei.requests.SendEphemerisOperatorResponse;
import id.icapps.savera.service.devices.huawei.requests.SendEphemerisParameterConsultRequest;
import id.icapps.savera.service.devices.huawei.requests.SendEphemerisSingleFileInfoResponse;
import id.icapps.savera.util.CheckSums;
import id.icapps.savera.util.CryptoUtils;
