...
import id.icapps.savera.service.devices.huami.HuamiActivityDetailsParser;
...
public class FetchSportsDetailsOperation extends AbstractFetchOperation {
    ...
    protected boolean processBufferedData() {
        ...
        try {
            ...
            final String fileName = FileUtils.makeValidFileName("saverawatch-" + trackType.toLowerCase() + "-" + DateTimeUtils.formatIso8601(summary.getStartTime()) + ".gpx");
