...
package id.icapps.savera.service.devices.fitpro;

import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_ALARM;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_DND;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_FIND_BAND;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_GET_HW_INFO;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_GROUP_BAND_INFO;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_GROUP_BIND;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_GROUP_GENERAL;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_GROUP_HEARTRATE_SETTINGS;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_GROUP_RECEIVE_BUTTON_DATA;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_GROUP_RECEIVE_SPORTS_DATA;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_GROUP_REQUEST_DATA;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_GROUP_RESET;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_HEART_RATE_MEASUREMENT;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_NOTIFICATIONS_ENABLE;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_NOTIFICATION_CALL;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_NOTIFICATION_MESSAGE;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_REQUEST_STEPS_DATA0x10;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_REQUEST_STEPS_DATA0x7;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_REQUEST_STEPS_DATA0x8;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_REQUEST_STEPS_DATA1;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_RESET;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_RX_BAND_INFO;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_SET_ARM;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_SET_DATE_TIME;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_SET_DEVICE_VIBRATIONS;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_SET_DISPLAY_ON_LIFT;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_SET_LANGUAGE;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_SET_LONG_SIT_REMINDER;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_SET_SLEEP_TIMES;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_SET_STEP_GOAL;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_SET_USER_DATA;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_UNBIND;
import static id.icapps.savera.devices.fitpro.FitProConstants.CMD_WEATHER;
import static id.icapps.savera.devices.fitpro.FitProConstants.GENDER_FEMALE;
import static id.icapps.savera.devices.fitpro.FitProConstants.GENDER_MALE;
import static id.icapps.savera.devices.fitpro.FitProConstants.NOTIFICATION_ICON_FACEBOOK;
import static id.icapps.savera.devices.fitpro.FitProConstants.NOTIFICATION_ICON_INSTAGRAM;
import static id.icapps.savera.devices.fitpro.FitProConstants.NOTIFICATION_ICON_LINE;
import static id.icapps.savera.devices.fitpro.FitProConstants.NOTIFICATION_ICON_QQ;
import static id.icapps.savera.devices.fitpro.FitProConstants.NOTIFICATION_ICON_SMS;
import static id.icapps.savera.devices.fitpro.FitProConstants.NOTIFICATION_ICON_TWITTER;
import static id.icapps.savera.devices.fitpro.FitProConstants.NOTIFICATION_ICON_WECHAT;
import static id.icapps.savera.devices.fitpro.FitProConstants.NOTIFICATION_ICON_WHATSAPP;
import static id.icapps.savera.devices.fitpro.FitProConstants.RX_CAMERA1;
import static id.icapps.savera.devices.fitpro.FitProConstants.RX_CAMERA2;
import static id.icapps.savera.devices.fitpro.FitProConstants.RX_CAMERA3;
import static id.icapps.savera.devices.fitpro.FitProConstants.RX_FIND_PHONE;
import static id.icapps.savera.devices.fitpro.FitProConstants.RX_HEART_RATE_DATA;
import static id.icapps.savera.devices.fitpro.FitProConstants.RX_MEDIA_BACK;
import static id.icapps.savera.devices.fitpro.FitProConstants.RX_MEDIA_FORW;
import static id.icapps.savera.devices.fitpro.FitProConstants.RX_MEDIA_PLAY_PAUSE;
import static id.icapps.savera.devices.fitpro.FitProConstants.RX_SLEEP_DATA;
import static id.icapps.savera.devices.fitpro.FitProConstants.RX_SPORTS_DAY_DATA;
import static id.icapps.savera.devices.fitpro.FitProConstants.RX_STEP_DATA;
import static id.icapps.savera.devices.fitpro.FitProConstants.UNIT_IMPERIAL;
import static id.icapps.savera.devices.fitpro.FitProConstants.UNIT_METRIC;
import static id.icapps.savera.devices.fitpro.FitProConstants.UUID_CHARACTERISTIC_RX;
import static id.icapps.savera.devices.fitpro.FitProConstants.UUID_CHARACTERISTIC_TX;
import static id.icapps.savera.devices.fitpro.FitProConstants.VALUE_OFF;
import static id.icapps.savera.devices.fitpro.FitProConstants.VALUE_ON;
import static id.icapps.savera.devices.fitpro.FitProConstants.VALUE_SET_ARM_LEFT;
import static id.icapps.savera.devices.fitpro.FitProConstants.VALUE_SET_ARM_RIGHT;
import static id.icapps.savera.devices.fitpro.FitProConstants.VALUE_SET_DEVICE_VIBRATIONS_DISABLE;
import static id.icapps.savera.devices.fitpro.FitProConstants.VALUE_SET_DEVICE_VIBRATIONS_ENABLE;
import static id.icapps.savera.devices.fitpro.FitProConstants.VALUE_SET_LONG_SIT_REMINDER_OFF;
import static id.icapps.savera.devices.fitpro.FitProConstants.VALUE_SET_LONG_SIT_REMINDER_ON;
import static id.icapps.savera.devices.fitpro.FitProConstants.VALUE_SET_NOTIFICATIONS_ENABLE_OFF;
import static id.icapps.savera.devices.fitpro.FitProConstants.VALUE_SET_NOTIFICATIONS_ENABLE_ON;
...
import id.icapps.savera.devices.fitpro.FitProConstants;
import id.icapps.savera.devices.fitpro.FitProSampleProvider;
...
import id.icapps.savera.service.btle.actions.SetDeviceBusyAction;
...
import id.icapps.savera.service.btle.profiles.deviceinfo.DeviceInfo;
...
public class FitProDeviceSupport extends AbstractBTLEDeviceSupport {
        ...
        IntentListener mListener = new IntentListener() {
            ...
            public void notify(Intent intent) {
                ...
                if (DeviceInfoProfile.ACTION_DEVICE_INFO.equals(action)) {
                    ...
                    handleBatteryInfo((id.icapps.savera.service.btle.profiles.battery.BatteryInfo) intent.getParcelableExtra(BatteryInfoProfile.EXTRA_BATTERY_INFO));
                }
            }
        };
    ...
    public void sendAck(byte command_group, byte length_high, byte length_low, byte command) {
        LOG.debug(" ACKing data: " + id.icapps.savera.util.ArrayUtils.arrayToString(new byte[]{command_group}) + " " + id.icapps.savera.util.ArrayUtils.arrayToString(new byte[]{command}));
        TransactionBuilder builder = new TransactionBuilder("notification");
    ...
    public void handleBatteryInfo(id.icapps.savera.service.btle.profiles.battery.BatteryInfo info) {
        LOG.debug("FitPro battery info: " + info);
        batteryCmd.level = (short) info.getPercentCharged();
        handleGBDeviceEvent(batteryCmd);
    }

    /*   public void handleDeviceInfo(id.icapps.savera.service.btle.profiles.deviceinfo.DeviceInfo info) {
           LOG.debug("FitPro device info: " + info);
           versionCmd.hwVersion = "+FitPro";
           versionCmd.fwVersion = info.getFirmwareRevision();
           handleGBDeviceEvent(versionCmd);
    ...
    public static void debugPrintArray(byte[] bytes, String label) {
        ...
        String arrayString = id.icapps.savera.util.ArrayUtils.arrayToString(bytes);
    ...
    public void onSetAlarms(ArrayList<? extends Alarm> alarms) {
        ...
        if (alarms.toArray().length == 1 && alarms.get(0).getRepetition() == 0) { //single shot?
            ...
            alarms = (ArrayList<? extends Alarm>) AlarmUtils.mergeOneshotToDeviceAlarms(gbDevice, (id.icapps.savera.entities.Alarm) oneshot, 7);
        }
