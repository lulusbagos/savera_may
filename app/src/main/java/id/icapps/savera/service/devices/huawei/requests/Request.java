...
// Based on id.icapps.savera.service.devices.lefun.requests.Request
...
public class Request {
    ...
    private id.icapps.savera.service.btbr.TransactionBuilder builderBr;
    private id.icapps.savera.service.btle.TransactionBuilder builderLe;
    ...
    public Request(HuaweiSupportProvider supportProvider, id.icapps.savera.service.btbr.TransactionBuilder builder) {
    ...
    public Request(HuaweiSupportProvider supportProvider, id.icapps.savera.service.btle.TransactionBuilder builder) {
        this.supportProvider = supportProvider;
        this.paramsProvider = supportProvider.getParamsProvider();
        assert supportProvider.isBLE();
    ...
    private void performConnected() throws IOException {
        ...
        if (!this.supportProvider.isBLE()) {
            id.icapps.savera.service.btbr.Transaction transaction = this.builderBr.getTransaction();
            this.supportProvider.performConnected(transaction);
        } else {
            id.icapps.savera.service.btle.Transaction transaction = this.builderLe.getTransaction();
            this.supportProvider.performConnected(transaction);
        }
    }
