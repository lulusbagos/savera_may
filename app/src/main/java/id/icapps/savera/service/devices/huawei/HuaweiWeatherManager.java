...
import id.icapps.savera.service.devices.huawei.requests.SendGpsAndTimeToDeviceRequest;
import id.icapps.savera.service.devices.huawei.requests.SendWeatherCurrentRequest;
import id.icapps.savera.service.devices.huawei.requests.SendWeatherDeviceRequest;
import id.icapps.savera.service.devices.huawei.requests.SendWeatherExtendedSupportRequest;
import id.icapps.savera.service.devices.huawei.requests.SendWeatherForecastRequest;
import id.icapps.savera.service.devices.huawei.requests.SendWeatherStartRequest;
import id.icapps.savera.service.devices.huawei.requests.SendWeatherSunMoonSupportRequest;
import id.icapps.savera.service.devices.huawei.requests.SendWeatherSupportRequest;
import id.icapps.savera.service.devices.huawei.requests.SendWeatherUnitRequest;
...
public class HuaweiWeatherManager {
    ...
    public void handleAsyncMessage(HuaweiPacket response) {
        if (response.getTlv().getInteger(0x7f, -1) == 0x000186AA) {
            // Send weather
            final ArrayList<WeatherSpec> specs = new ArrayList<>(id.icapps.savera.model.Weather.getInstance().getWeatherSpecs());
