...
package id.icapps.savera.service.devices.qhybrid.adapter.misfit;

import static id.icapps.savera.service.devices.qhybrid.QHybridSupport.ITEM_ACTIVITY_POINT;
import static id.icapps.savera.service.devices.qhybrid.QHybridSupport.ITEM_STEP_COUNT;
...
import static id.icapps.savera.service.devices.qhybrid.QHybridSupport.QHYBRID_EVENT_FILE_UPLOADED;
...
import id.icapps.savera.service.devices.qhybrid.requests.misfit.ActivityPointGetRequest;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.AnimationRequest;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.BatteryLevelRequest;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.DownloadFileRequest;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.EraseFileRequest;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.FileRequest;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.GetCountdownSettingsRequest;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.GetCurrentStepCountRequest;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.GetStepGoalRequest;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.GetVibrationStrengthRequest;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.GoalTrackingGetRequest;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.ListFilesRequest;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.MoveHandsRequest;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.OTAEnterRequest;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.OTAEraseRequest;
...
import id.icapps.savera.service.devices.qhybrid.requests.misfit.SetCurrentStepCountRequest;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.SetStepGoalRequest;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.SetTimeRequest;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.SetVibrationStrengthRequest;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.UploadFileRequest;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.VibrateRequest;
