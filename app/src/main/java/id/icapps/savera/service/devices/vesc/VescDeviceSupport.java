...
package id.icapps.savera.service.devices.vesc;
...
public class VescDeviceSupport extends VescBaseDeviceSupport {
    ...
    public static final String COMMAND_SET_RPM = "id.icapps.savera.vesc.command.SET_RPM";
    public static final String COMMAND_SET_CURRENT = "id.icapps.savera.vesc.command.SET_CURRENT";
    public static final String COMMAND_SET_BREAK_CURRENT = "id.icapps.savera.vesc.command.SET_BREAK_CURRENT";
    public static final String COMMAND_GET_VALUES = "id.icapps.savera.vesc.command.GET_VALUES";
    ...
    public static final String ACTION_GOT_VALUES = "id.icapps.savera.vesc.action.GOT_VALUES";
