...
import id.icapps.savera.devices.huawei.packets.App;
import id.icapps.savera.devices.huawei.packets.Calls;
import id.icapps.savera.devices.huawei.packets.CameraRemote;
import id.icapps.savera.devices.huawei.packets.DeviceConfig;
...
import id.icapps.savera.devices.huawei.packets.FindPhone;
import id.icapps.savera.devices.huawei.packets.GpsAndTime;
import id.icapps.savera.devices.huawei.packets.Menstrual;
import id.icapps.savera.devices.huawei.packets.MusicControl;
import id.icapps.savera.devices.huawei.packets.FileUpload;
import id.icapps.savera.devices.huawei.packets.P2P;
import id.icapps.savera.devices.huawei.packets.Watchface;
import id.icapps.savera.devices.huawei.packets.Weather;
import id.icapps.savera.service.devices.huawei.requests.Request;
import id.icapps.savera.service.devices.huawei.requests.GetPhoneInfoRequest;
import id.icapps.savera.service.devices.huawei.requests.SendFileUploadComplete;
import id.icapps.savera.service.devices.huawei.requests.SendGpsStatusRequest;
import id.icapps.savera.service.devices.huawei.requests.SendMenstrualModifyTimeRequest;
import id.icapps.savera.service.devices.huawei.requests.SendFileUploadAck;
import id.icapps.savera.service.devices.huawei.requests.SendFileUploadChunk;
import id.icapps.savera.service.devices.huawei.requests.SendFileUploadHash;
import id.icapps.savera.service.devices.huawei.requests.SendWatchfaceConfirm;
import id.icapps.savera.service.devices.huawei.requests.SendWatchfaceOperation;
import id.icapps.savera.service.devices.huawei.requests.SetMusicStatusRequest;
