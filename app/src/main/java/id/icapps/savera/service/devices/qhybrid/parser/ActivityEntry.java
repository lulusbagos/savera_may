...
package id.icapps.savera.service.devices.qhybrid.parser;
...
public class ActivityEntry {
    ...
    public enum WEARING_STATE {
        ...
        static public WEARING_STATE fromValue(byte value) {
            switch (value) {
                case 0:
                    return WEARING_STATE.WEARING;
                case 1:
                    return WEARING_STATE.NOT_WEARING;
                case 2:
                    return WEARING_STATE.UNKNOWN;
                default:
                    throw new RuntimeException("value " + value + " not valid state value");
            }
        }
    }
}
