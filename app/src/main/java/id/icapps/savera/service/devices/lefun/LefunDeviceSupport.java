...
package id.icapps.savera.service.devices.lefun;
...
import id.icapps.savera.devices.lefun.commands.FeaturesCommand;
import id.icapps.savera.devices.lefun.commands.FindPhoneCommand;
import id.icapps.savera.devices.lefun.commands.GetActivityDataCommand;
import id.icapps.savera.devices.lefun.commands.GetPpgDataCommand;
import id.icapps.savera.devices.lefun.commands.GetSleepDataCommand;
import id.icapps.savera.devices.lefun.commands.GetStepsDataCommand;
import id.icapps.savera.devices.lefun.commands.PpgResultCommand;
import id.icapps.savera.devices.lefun.commands.SettingsCommand;
import id.icapps.savera.entities.DaoSession;
import id.icapps.savera.entities.LefunActivitySample;
import id.icapps.savera.entities.LefunActivitySampleDao;
import id.icapps.savera.entities.LefunBiometricSample;
import id.icapps.savera.entities.LefunSleepSample;
...
import id.icapps.savera.service.devices.lefun.requests.FindDeviceRequest;
import id.icapps.savera.service.devices.lefun.requests.GetActivityDataRequest;
import id.icapps.savera.service.devices.lefun.requests.GetBatteryLevelRequest;
import id.icapps.savera.service.devices.lefun.requests.GetEnabledFeaturesRequest;
import id.icapps.savera.service.devices.lefun.requests.GetFirmwareInfoRequest;
import id.icapps.savera.service.devices.lefun.requests.GetGeneralSettingsRequest;
import id.icapps.savera.service.devices.lefun.requests.GetHydrationReminderIntervalRequest;
import id.icapps.savera.service.devices.lefun.requests.GetPpgDataRequest;
import id.icapps.savera.service.devices.lefun.requests.GetSedentaryReminderIntervalRequest;
import id.icapps.savera.service.devices.lefun.requests.GetSleepDataRequest;
import id.icapps.savera.service.devices.lefun.requests.Request;
import id.icapps.savera.service.devices.lefun.requests.SendCallNotificationRequest;
import id.icapps.savera.service.devices.lefun.requests.SendNotificationRequest;
import id.icapps.savera.service.devices.lefun.requests.SetAlarmRequest;
import id.icapps.savera.service.devices.lefun.requests.SetEnabledFeaturesRequest;
import id.icapps.savera.service.devices.lefun.requests.SetGeneralSettingsRequest;
import id.icapps.savera.service.devices.lefun.requests.SetHydrationReminderIntervalRequest;
import id.icapps.savera.service.devices.lefun.requests.SetLanguageRequest;
import id.icapps.savera.service.devices.lefun.requests.SetProfileRequest;
import id.icapps.savera.service.devices.lefun.requests.SetSedentaryReminderIntervalRequest;
import id.icapps.savera.service.devices.lefun.requests.SetTimeRequest;
import id.icapps.savera.service.devices.lefun.requests.StartPpgRequest;
...
public class LefunDeviceSupport extends AbstractBTLEDeviceSupport {
    ...
    // Adapted from id.icapps.savera.service.devices.makibeshr3.MakibesHR3DeviceSupport.broadcastSample
