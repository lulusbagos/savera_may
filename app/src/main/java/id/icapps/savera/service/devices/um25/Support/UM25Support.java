...
package id.icapps.savera.service.devices.um25.Support;
...
import id.icapps.savera.devices.um25.Activity.DataActivity;
...
import id.icapps.savera.service.devices.um25.Data.CaptureGroup;
import id.icapps.savera.service.devices.um25.Data.MeasurementData;
...
public class UM25Support extends UM25BaseSupport {
    ...
    public static final String ACTION_MEASUREMENT_TAKEN = "com.nodomain.savera.um25.MEASUREMENT_TAKEN";
    public static final String ACTION_RESET_STATS = "com.nodomain.savera.um25.RESET_STATS";
