package id.icapps.savera.service.devices.idasen;
...
import id.icapps.savera.devices.idasen.IdasenConstants;
...
public class IdasenDeviceSupport extends AbstractBTLEDeviceSupport {
    ...
    public static final String COMMAND_UP = "id.icapps.savera.idasen.command.UP";
    public static final String COMMAND_DOWN = "id.icapps.savera.idasen.command.DOWN";
    public static final String COMMAND_SET_HEIGHT = "id.icapps.savera.idasen.command.SET_HEIGHT";
    public static final String COMMAND_GET_DESK_VALUES = "id.icapps.savera.idasen.command.GET_DESK_VALUES";
