...
package id.icapps.savera.service.devices.binary_sensor;
...
import id.icapps.savera.service.devices.binary_sensor.protocol.constants.MessageId;
import id.icapps.savera.service.devices.binary_sensor.protocol.constants.ParameterId;
import id.icapps.savera.service.devices.binary_sensor.protocol.constants.ReportState;
import id.icapps.savera.service.devices.binary_sensor.protocol.constants.SensorType;
import id.icapps.savera.service.devices.binary_sensor.protocol.message.GetSensorRequest;
import id.icapps.savera.service.devices.binary_sensor.protocol.message.Response;
import id.icapps.savera.service.devices.binary_sensor.protocol.message.SetSensorRequest;
import id.icapps.savera.service.devices.binary_sensor.protocol.parameter.Parameter;
import id.icapps.savera.service.devices.binary_sensor.protocol.parameter.SensorState;
...
public class BinarySensorSupport extends BinarySensorBaseSupport {
    ...
    final public static String ACTION_SENSOR_STATE_CHANGED = "id.icapps.savera.binary_sensor.STATE_CHANGED";
    final public static String ACTION_SENSOR_STATE_REQUEST = "id.icapps.savera.binary_sensor.STATE_REQUEST";

    private static final Logger logger = LoggerFactory.getLogger(BinarySensorSupport.class);

    private id.icapps.savera.service.devices.binary_sensor.protocol.constants.SensorState sensorState = null;
    ...
    void sendStateChangeIntent(boolean sendGlobally) {
        ...
        intent.putExtra("EXTRA_SENSOR_CLOSED", sensorState == id.icapps.savera.service.devices.binary_sensor.protocol.constants.SensorState.SENSOR_STATE_CLOSED);
