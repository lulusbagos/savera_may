...
import id.icapps.savera.activities.CameraActivity;
import id.icapps.savera.activities.FindPhoneActivity;
import id.icapps.savera.activities.appmanager.AbstractAppManagerFragment;
...
import id.icapps.savera.deviceevents.GBDeviceEventFmFrequency;
...
import id.icapps.savera.deviceevents.GBDeviceEventUpdateDeviceInfo;
import id.icapps.savera.deviceevents.GBDeviceEventLEDColor;
...
import id.icapps.savera.deviceevents.GBDeviceEventUpdateDeviceState;
...
import id.icapps.savera.entities.BatteryLevel;
...
import id.icapps.savera.service.receivers.GBCallControlReceiver;
import id.icapps.savera.service.receivers.GBMusicControlReceiver;
...
public abstract class AbstractDeviceSupport implements DeviceSupport {
     ...
     *
     * @param reminders {@link java.util.ArrayList} containing {@link id.icapps.savera.model.Reminder} instances
     */
    @Override
     ...
     * overridden and implemented by the device support class.
     *
     * @param clocks {@link java.util.ArrayList} containing {@link id.icapps.savera.model.WorldClock} instances
     */
    @Override
     ...
     * overridden and implemented by the device support class.
     *
     * @param contacts {@link java.util.ArrayList} containing {@link id.icapps.savera.model.Contact} instances
     */
    @Override
     ...
     * overridden and implemented by the device support class.
     *
     * @param alarms {@link java.util.ArrayList} containing {@link id.icapps.savera.model.Alarm} instances
     */
    @Override
