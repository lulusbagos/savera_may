...
import static id.icapps.savera.devices.huawei.packets.DeviceConfig.LinkParams;
...
public class GetLinkParamsRequest extends Request {
    ...
    public GetLinkParamsRequest(
            ...
            id.icapps.savera.service.btbr.TransactionBuilder builder
    ) {
    ...
    public GetLinkParamsRequest(
            HuaweiSupportProvider support,
            id.icapps.savera.service.btle.TransactionBuilder builder
    ) {
        super(support, builder);
        this.serviceId = DeviceConfig.id;
        this.commandId = LinkParams.id;
