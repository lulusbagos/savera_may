...
package id.icapps.savera.service.devices.qhybrid;
...
import id.icapps.savera.service.devices.qhybrid.adapter.WatchAdapterFactory;
import id.icapps.savera.service.devices.qhybrid.adapter.fossil.FossilWatchAdapter;
import id.icapps.savera.service.devices.qhybrid.adapter.fossil_hr.FossilHRWatchAdapter;
import id.icapps.savera.service.devices.qhybrid.file.FileHandle;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.DownloadFileRequest;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.MoveHandsRequest;
import id.icapps.savera.service.devices.qhybrid.requests.misfit.PlayNotificationRequest;
...
public class QHybridSupport extends QHybridBaseSupport {
    ...
    public static final String QHYBRID_COMMAND_UPDATE_SETTINGS = "id.icapps.savera.Q_UPDATE_SETTINGS";
    public static final String QHYBRID_COMMAND_OVERWRITE_BUTTONS = "id.icapps.savera.Q_OVERWRITE_BUTTONS";
    public static final String QHYBRID_COMMAND_UPDATE_WIDGETS = "id.icapps.savera.Q_UPDATE_WIDGETS";
    public static final String QHYBRID_COMMAND_SET_MENU_MESSAGE = "id.icapps.savera.Q_SET_MENU_MESSAGE";
    public static final String QHYBRID_COMMAND_SEND_MENU_ITEMS = "id.icapps.savera.Q_SEND_MENU_ITEMS";
    public static final String QHYBRID_COMMAND_SET_WIDGET_CONTENT = "id.icapps.savera.Q_SET_WIDGET_CONTENT";
    public static final String QHYBRID_COMMAND_SET_BACKGROUND_IMAGE = "id.icapps.savera.Q_SET_BACKGROUND_IMAGE";
    public static final String QHYBRID_COMMAND_UNINSTALL_APP = "id.icapps.savera.Q_UNINSTALL_APP";
    public static final String QHYBRID_COMMAND_PUSH_CONFIG = "id.icapps.savera.Q_PUSH_CONFIG";
    public static final String QHYBRID_COMMAND_SWITCH_WATCHFACE = "id.icapps.savera.Q_SWITCH_WATCHFACE";

    public static final String QHYBRID_COMMAND_DOWNLOAD_FILE = "id.icapps.savera.Q_DOWNLOAD_FILE";
    public static final String QHYBRID_COMMAND_UPLOAD_FILE = "id.icapps.savera.Q_UPLOAD_FILE";

    public static final String QHYBRID_COMMAND_SET_MENU_STRUCTURE = "id.icapps.savera.Q_SET_MENU_STRUCTURE";

    public static final String QHYBRID_ACTION_DOWNLOADED_FILE = "id.icapps.savera.Q_DOWNLOADED_FILE";
    public static final String QHYBRID_ACTION_UPLOADED_FILE = "id.icapps.savera.Q_UPLOADED_FILE";

    private static final String QHYBRID_ACTION_SET_ACTIVITY_HAND = "id.icapps.savera.Q_SET_ACTIVITY_HAND";

    public static final String QHYBRID_EVENT_SETTINGS_UPDATED = "id.icapps.savera.Q_SETTINGS_UPDATED";
    public static final String QHYBRID_EVENT_FILE_UPLOADED = "id.icapps.savera.Q_FILE_UPLOADED";
    public static final String QHYBRID_COMMAND_NOTIFICATION_CONFIG_CHANGED = "id.icapps.savera.Q_NOTIFICATION_CONFIG_CHANGED";

    public static final String QHYBRID_EVENT_BUTTON_PRESS = "id.icapps.savera.Q_BUTTON_PRESSED";
    public static final String QHYBRID_EVENT_MULTI_BUTTON_PRESS = "id.icapps.savera.Q_MULTI_BUTTON_PRESSED";
    public static final String QHYBRID_EVENT_COMMUTE_MENU = "id.icapps.savera.Q_COMMUTE_MENU";
                ...
                switch (intent.getAction()) {
                    case QHYBRID_COMMAND_CONTROL: {
                        ...
                        if (config != null) {
                            ...
                            if (config.getSubEye() != -1)
                                movement.setHourDegrees(config.getSubEye());
                    ...
                    case QHYBRID_COMMAND_MOVE: {
                        ...
                        if (extras.containsKey("EXTRA_DISTANCE_HOUR"))
                            movement.setHourDegrees(extras.getShort("EXTRA_DISTANCE_HOUR"));
                        if (extras.containsKey("EXTRA_DISTANCE_MINUTE"))
                            movement.setMinuteDegrees(extras.getShort("EXTRA_DISTANCE_MINUTE"));
                        if (extras.containsKey("EXTRA_DISTANCE_SUB"))
                            movement.setSubDegrees(extras.getShort("EXTRA_DISTANCE_SUB"));
                        watchAdapter.setHands(movement);
                        break;
                    }
