...
package id.icapps.savera.service.devices.banglejs;

import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_ALLOW_HIGH_MTU;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_BANGLEJS_TEXT_BITMAP;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_BANGLEJS_TEXT_BITMAP_SIZE;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DEVICE_GPS_UPDATE;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DEVICE_GPS_UPDATE_INTERVAL;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DEVICE_GPS_USE_NETWORK_ONLY;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DEVICE_INTENTS;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DEVICE_INTERNET_ACCESS;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_NOTIFICATION_WAKE_ON_OPEN;
import static id.icapps.savera.database.DBHelper.getUser;
import static id.icapps.savera.devices.banglejs.BangleJSConstants.PREF_BANGLEJS_ACTIVITY_FULL_SYNC_START;
import static id.icapps.savera.devices.banglejs.BangleJSConstants.PREF_BANGLEJS_ACTIVITY_FULL_SYNC_STATUS;
...
import id.icapps.savera.activities.WakeActivity;
import id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst;
import id.icapps.savera.capabilities.loyaltycards.BarcodeFormat;
...
import id.icapps.savera.devices.banglejs.BangleJSConstants;
import id.icapps.savera.devices.banglejs.BangleJSSampleProvider;
import id.icapps.savera.entities.BangleJSActivitySample;
import id.icapps.savera.entities.CalendarSyncState;
import id.icapps.savera.entities.CalendarSyncStateDao;
...
public class BangleJSDeviceSupport extends AbstractBTLEDeviceSupport {
    ...
    private void setSleepAsAndroidAlarm(long alarmTimestamp) {
        ...
        id.icapps.savera.entities.Alarm currentAlarm = DBHelper.getAlarms(gbDevice).get(SleepAsAndroidSender.getAlarmSlot());
    ...
    private void handleIntent(JSONObject json) throws JSONException {
        ...
        if (json.has("package") && !json.has("class")) {
            in = json.getString("package").equals("saverawatch") ?
    ...
    public boolean isCharCodeEmoji(char ch) {
        ...
        if (ch >= 0xFE00 && ch <= 0xFE0F)
            return true; // variation selector 1 (2 is U+E0100 so is in a surrogate)
