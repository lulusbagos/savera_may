...
package id.icapps.savera.service.devices.supercars;
...
import id.icapps.savera.devices.supercars.SuperCarsConstants;
...
public class SuperCarsSupport extends AbstractBTLEDeviceSupport {
    ...
    public static final String COMMAND_DRIVE_CONTROL = "id.icapps.savera.supercars.command.DRIVE_CONTROL";
