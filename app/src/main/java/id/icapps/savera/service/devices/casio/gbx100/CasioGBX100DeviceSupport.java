...
package id.icapps.savera.service.devices.casio.gbx100;
...
import id.icapps.savera.devices.casio.CasioConstants;
import id.icapps.savera.devices.casio.gbx100.CasioGBX100SampleProvider;
import id.icapps.savera.entities.CasioGBX100ActivitySample;
...
import id.icapps.savera.service.devices.casio.Casio2C2DSupport;
import id.icapps.savera.util.GB;
import id.icapps.savera.util.StringUtils;

import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_AUTOLIGHT;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_AUTOREMOVE_MESSAGE;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_CASIO_ALERT_CALENDAR;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_CASIO_ALERT_CALL;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_CASIO_ALERT_EMAIL;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_CASIO_ALERT_OTHER;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_CASIO_ALERT_SMS;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_FAKE_RING_DURATION;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_FIND_PHONE;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_FIND_PHONE_DURATION;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_KEY_VIBRATION;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_OPERATING_SOUNDS;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_PREVIEW_MESSAGE_IN_TITLE;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_TIMEFORMAT;
import static id.icapps.savera.model.ActivityUser.PREF_USER_ACTIVETIME_MINUTES;
import static id.icapps.savera.model.ActivityUser.PREF_USER_DATE_OF_BIRTH;
import static id.icapps.savera.model.ActivityUser.PREF_USER_DISTANCE_METERS;
...
import static id.icapps.savera.model.ActivityUser.PREF_USER_STEPS_GOAL;
