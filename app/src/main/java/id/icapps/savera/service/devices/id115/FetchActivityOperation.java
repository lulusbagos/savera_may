...
package id.icapps.savera.service.devices.id115;
...
import id.icapps.savera.devices.id115.ID115Constants;
import id.icapps.savera.devices.id115.ID115SampleProvider;
import id.icapps.savera.entities.ID115ActivitySample;
