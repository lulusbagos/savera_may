...
package id.icapps.savera.service.devices.huami;
...
import id.icapps.savera.capabilities.password.PasswordCapabilityImpl;
...
import id.icapps.savera.deviceevents.GBDeviceEventCallControl;
...
import id.icapps.savera.deviceevents.GBDeviceEventNotificationControl;
import id.icapps.savera.deviceevents.GBDeviceEventSleepStateDetection;
import id.icapps.savera.deviceevents.GBDeviceEventSilentMode;
import id.icapps.savera.deviceevents.GBDeviceEventVersionInfo;
import id.icapps.savera.deviceevents.GBDeviceEventWearState;
import id.icapps.savera.devices.DeviceCoordinator;
import id.icapps.savera.devices.SampleProvider;
import id.icapps.savera.devices.huami.ActivateDisplayOnLift;
import id.icapps.savera.devices.huami.ActivateDisplayOnLiftSensitivity;
import id.icapps.savera.devices.huami.DisconnectNotificationSetting;
import id.icapps.savera.devices.huami.zeppos.ZeppOsCoordinator;
import id.icapps.savera.devices.huami.Huami2021Service;
...
import id.icapps.savera.devices.huami.HuamiWeatherConditions;
import id.icapps.savera.devices.huami.amazfitbip.AmazfitBipService;
import id.icapps.savera.devices.huami.miband3.MiBand3Coordinator;
import id.icapps.savera.devices.huami.miband3.MiBand3Service;
import id.icapps.savera.devices.miband.DateTimeDisplay;
import id.icapps.savera.devices.miband.DoNotDisturb;
import id.icapps.savera.devices.miband.MiBand2SampleProvider;
import id.icapps.savera.devices.miband.MiBandConst;
import id.icapps.savera.devices.miband.MiBandCoordinator;
import id.icapps.savera.devices.miband.MiBandService;
import id.icapps.savera.devices.miband.VibrationProfile;
import id.icapps.savera.entities.DaoSession;
import id.icapps.savera.entities.Device;
import id.icapps.savera.entities.MiBandActivitySample;
import id.icapps.savera.entities.User;
import id.icapps.savera.externalevents.gps.GBLocationProviderType;
import id.icapps.savera.externalevents.gps.GBLocationService;
import id.icapps.savera.externalevents.opentracks.OpenTracksController;
import id.icapps.savera.impl.GBDevice;
import id.icapps.savera.impl.GBDevice.State;
...
import id.icapps.savera.model.SleepState;
import id.icapps.savera.model.WearingState;
import id.icapps.savera.service.SleepAsAndroidSender;
import id.icapps.savera.service.devices.huami.operations.fetch.AbstractFetchOperation;
import id.icapps.savera.service.devices.huami.operations.fetch.FetchStatisticsOperation;
import id.icapps.savera.service.devices.huami.operations.fetch.FetchTemperatureOperation;
import id.icapps.savera.service.devices.huami.operations.fetch.FetchHeartRateManualOperation;
import id.icapps.savera.service.devices.huami.operations.fetch.FetchHeartRateMaxOperation;
import id.icapps.savera.service.devices.huami.operations.fetch.FetchHeartRateRestingOperation;
...
import id.icapps.savera.service.devices.huami.operations.fetch.FetchDebugLogsOperation;
import id.icapps.savera.service.devices.huami.zeppos.services.ZeppOsCannedMessagesService;
import id.icapps.savera.util.MediaManager;
import id.icapps.savera.util.SilentMode;
import id.icapps.savera.util.calendar.CalendarEvent;
import id.icapps.savera.util.calendar.CalendarManager;
...
import id.icapps.savera.model.Weather;
...
import id.icapps.savera.service.btle.BtLEAction;
...
import id.icapps.savera.service.btle.actions.ConditionalWriteAction;
...
import id.icapps.savera.service.btle.profiles.alertnotification.AlertNotificationProfile;
import id.icapps.savera.service.btle.profiles.alertnotification.NewAlert;
import id.icapps.savera.service.btle.profiles.deviceinfo.DeviceInfoProfile;
...
import id.icapps.savera.service.devices.huami.miband2.Mi2NotificationStrategy;
import id.icapps.savera.service.devices.huami.miband2.Mi2TextNotificationStrategy;
import id.icapps.savera.service.devices.huami.operations.fetch.FetchActivityOperation;
import id.icapps.savera.service.devices.huami.operations.init.InitOperation;
import id.icapps.savera.service.devices.huami.operations.init.InitOperation2021;
import id.icapps.savera.service.devices.huami.operations.update.UpdateFirmwareOperation;
import id.icapps.savera.service.devices.miband.NotificationStrategy;
import id.icapps.savera.service.devices.miband.RealtimeSamplesSupport;
...
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_ACTIVATE_DISPLAY_ON_LIFT;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_ALLOW_HIGH_MTU;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_BT_CONNECTED_ADVERTISEMENT;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DATEFORMAT;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DISPLAY_ON_LIFT_SENSITIVITY;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DISPLAY_ON_LIFT_START;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DISPLAY_ON_LIFT_END;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DISCONNECT_NOTIFICATION;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DISCONNECT_NOTIFICATION_START;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DISCONNECT_NOTIFICATION_END;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DO_NOT_DISTURB;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DO_NOT_DISTURB_START;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DO_NOT_DISTURB_END;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DO_NOT_DISTURB_LIFT_WRIST;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_HEARTRATE_ACTIVITY_MONITORING;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_HEARTRATE_ALERT_ENABLED;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_HEARTRATE_ALERT_HIGH_THRESHOLD;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_HEARTRATE_ALERT_LOW_THRESHOLD;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_HEARTRATE_STRESS_MONITORING;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_HOURLY_CHIME_ENABLE;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_HOURLY_CHIME_END;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_HOURLY_CHIME_START;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_INACTIVITY_ENABLE;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_INACTIVITY_START;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_INACTIVITY_END;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_INACTIVITY_THRESHOLD;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_INACTIVITY_DND;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_INACTIVITY_DND_START;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_INACTIVITY_DND_END;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_LANGUAGE;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_RESERVER_ALARMS_CALENDAR;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_SOUNDS;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_SYNC_CALENDAR;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_TIMEFORMAT;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_USER_FITNESS_GOAL_NOTIFICATION;
import static id.icapps.savera.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_WEARLOCATION;
import static id.icapps.savera.devices.huami.Huami2021Service.WORKOUT_GPS_FLAG_POSITION;
import static id.icapps.savera.devices.huami.Huami2021Service.WORKOUT_GPS_FLAG_STATUS;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_BUTTON_ACTION_SELECTION_BROADCAST;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_BUTTON_ACTION_SELECTION_FITNESS_APP_START;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_BUTTON_ACTION_SELECTION_FITNESS_APP_STOP;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_BUTTON_ACTION_SELECTION_FITNESS_APP_TOGGLE;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_BUTTON_ACTION_SELECTION_OFF;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_COUNT_ALARM;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_COUNT_APP_ALERTS;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_COUNT_EVENT_REMINDER;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_COUNT_FIND_BAND;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_COUNT_GOAL_NOTIFICATION;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_COUNT_IDLE_ALERTS;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_COUNT_INCOMING_CALL;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_COUNT_INCOMING_SMS;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_COUNT_PREFIX;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_COUNT_SCHEDULE;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_COUNT_TODO_LIST;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_PROFILE_ALARM;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_PROFILE_APP_ALERTS;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_PROFILE_EVENT_REMINDER;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_PROFILE_FIND_BAND;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_PROFILE_GOAL_NOTIFICATION;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_PROFILE_IDLE_ALERTS;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_PROFILE_INCOMING_CALL;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_PROFILE_INCOMING_SMS;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_PROFILE_PREFIX;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_PROFILE_SCHEDULE;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_PROFILE_TODO_LIST;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_TRY_ALARM;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_TRY_APP_ALERTS;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_TRY_EVENT_REMINDER;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_TRY_FIND_BAND;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_TRY_GOAL_NOTIFICATION;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_TRY_IDLE_ALERTS;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_TRY_INCOMING_CALL;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_TRY_INCOMING_SMS;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_TRY_PREFIX;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_TRY_SCHEDULE;
import static id.icapps.savera.devices.huami.HuamiConst.PREF_HUAMI_VIBRATION_TRY_TODO_LIST;
import static id.icapps.savera.devices.huami.HuamiService.COMMAND_ALARMS;
import static id.icapps.savera.devices.huami.HuamiService.COMMAND_ALARMS_WITH_TIMES;
import static id.icapps.savera.devices.huami.HuamiService.COMMAND_GPS_VERSION;
import static id.icapps.savera.devices.huami.HuamiService.COMMAND_WORKOUT_ACTIVITY_TYPES;
import static id.icapps.savera.devices.huami.HuamiService.DISPLAY_ITEM_BIT_CLOCK;
import static id.icapps.savera.devices.huami.HuamiService.ENDPOINT_DISPLAY;
import static id.icapps.savera.devices.huami.HuamiService.ENDPOINT_DISPLAY_ITEMS;
import static id.icapps.savera.devices.huami.HuamiService.MUSIC_FLAG_ALBUM;
import static id.icapps.savera.devices.huami.HuamiService.MUSIC_FLAG_ARTIST;
import static id.icapps.savera.devices.huami.HuamiService.MUSIC_FLAG_DURATION;
import static id.icapps.savera.devices.huami.HuamiService.MUSIC_FLAG_STATE;
import static id.icapps.savera.devices.huami.HuamiService.MUSIC_FLAG_TRACK;
import static id.icapps.savera.devices.huami.HuamiService.MUSIC_FLAG_VOLUME;
import static id.icapps.savera.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_COUNT;
import static id.icapps.savera.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_PROFILE;
import static id.icapps.savera.devices.miband.MiBandConst.VIBRATION_COUNT;
import static id.icapps.savera.devices.miband.MiBandConst.VIBRATION_PROFILE;
import static id.icapps.savera.devices.miband.MiBandConst.getNotificationPrefIntValue;
import static id.icapps.savera.devices.miband.MiBandConst.getNotificationPrefStringValue;
import static id.icapps.savera.model.ActivityUser.PREF_USER_DATE_OF_BIRTH;
import static id.icapps.savera.model.ActivityUser.PREF_USER_GENDER;
import static id.icapps.savera.model.ActivityUser.PREF_USER_HEIGHT_CM;
import static id.icapps.savera.model.ActivityUser.PREF_USER_NAME;
import static id.icapps.savera.model.ActivityUser.PREF_USER_WEIGHT_KG;
    ...
    private final IntentListener mListener = new IntentListener() {
        ...
        public void notify(Intent intent) {
            ...
            if (DeviceInfoProfile.ACTION_DEVICE_INFO.equals(s)) {
                handleDeviceInfo((id.icapps.savera.service.btle.profiles.deviceinfo.DeviceInfo) intent.getParcelableExtra(DeviceInfoProfile.EXTRA_DEVICE_INFO));
            }
        }
    };
...
//        byte[] tail = new byte[] { 0x2 }; // reason
    ...
    /**
     * Track the {@link id.icapps.savera.model.ActivityKind} that was opened, for the same reasons as {@code workoutNeedsGps}.
     */
    ...
    private void decodeAndUpdateAlarmStatus(byte[] response, boolean withTimes) {
        List<id.icapps.savera.entities.Alarm> alarms = DBHelper.getAlarms(gbDevice);
        int maxAlarms = 10;
        ...
        for (id.icapps.savera.entities.Alarm alarm : alarms) {
