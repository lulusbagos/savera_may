...
import id.icapps.savera.deviceevents.GBDeviceEventAppInfo;
import id.icapps.savera.deviceevents.GBDeviceEventCameraRemote;
import id.icapps.savera.deviceevents.GBDeviceEventDisplayMessage;
import id.icapps.savera.devices.DeviceCoordinator;
import id.icapps.savera.devices.huawei.HuaweiConstants;
import id.icapps.savera.devices.huawei.HuaweiCoordinator;
import id.icapps.savera.devices.huawei.HuaweiCoordinatorSupplier;
import id.icapps.savera.devices.huawei.HuaweiCoordinatorSupplier.HuaweiDeviceType;
import id.icapps.savera.devices.huawei.HuaweiCrypto;
import id.icapps.savera.devices.huawei.HuaweiGpsParser;
import id.icapps.savera.devices.huawei.HuaweiPacket;
import id.icapps.savera.devices.huawei.HuaweiSampleProvider;
import id.icapps.savera.devices.huawei.HuaweiTruSleepParser;
import id.icapps.savera.devices.huawei.packets.CameraRemote;
import id.icapps.savera.devices.huawei.packets.GpsAndTime;
import id.icapps.savera.devices.huawei.packets.Weather;
import id.icapps.savera.devices.huawei.packets.Workout;
...
import id.icapps.savera.entities.HuaweiActivitySample;
import id.icapps.savera.entities.HuaweiWorkoutDataSample;
import id.icapps.savera.entities.HuaweiWorkoutDataSampleDao;
import id.icapps.savera.entities.HuaweiWorkoutPaceSample;
import id.icapps.savera.entities.HuaweiWorkoutPaceSampleDao;
import id.icapps.savera.entities.HuaweiWorkoutSummarySample;
import id.icapps.savera.entities.HuaweiWorkoutSummarySampleDao;
...
import id.icapps.savera.impl.GBDeviceApp;
...
import id.icapps.savera.service.devices.huawei.p2p.HuaweiP2PCalendarService;
import id.icapps.savera.service.devices.huawei.requests.AcceptAgreementsRequest;
import id.icapps.savera.service.devices.huawei.requests.GetAppInfoParams;
import id.icapps.savera.service.devices.huawei.requests.GetContactsCount;
import id.icapps.savera.service.devices.huawei.requests.GetEventAlarmList;
import id.icapps.savera.service.devices.huawei.requests.GetGpsParameterRequest;
import id.icapps.savera.service.devices.huawei.requests.GetNotificationConstraintsRequest;
import id.icapps.savera.service.devices.huawei.requests.GetSmartAlarmList;
import id.icapps.savera.service.devices.huawei.requests.GetWatchfaceParams;
import id.icapps.savera.service.devices.huawei.requests.SendCameraRemoteSetupEvent;
import id.icapps.savera.service.devices.huawei.requests.SendDeviceReportThreshold;
import id.icapps.savera.service.devices.huawei.requests.SendExtendedAccountRequest;
import id.icapps.savera.service.devices.huawei.requests.SendFitnessUserInfoRequest;
import id.icapps.savera.service.devices.huawei.requests.SendGpsDataRequest;
import id.icapps.savera.service.devices.huawei.requests.SendFileUploadInfo;
import id.icapps.savera.service.devices.huawei.requests.SendRunPaceConfigRequest;
import id.icapps.savera.service.devices.huawei.requests.SendSetContactsRequest;
import id.icapps.savera.service.devices.huawei.requests.SendNotifyHeartRateCapabilityRequest;
import id.icapps.savera.service.devices.huawei.requests.SendNotifyRestHeartRateCapabilityRequest;
import id.icapps.savera.service.devices.huawei.requests.SetAutomaticHeartrateRequest;
import id.icapps.savera.service.devices.huawei.requests.SetAutomaticSpoRequest;
import id.icapps.savera.service.devices.huawei.requests.SetDisconnectNotification;
import id.icapps.savera.service.devices.huawei.requests.SetMediumToStrengthThresholdRequest;
import id.icapps.savera.service.devices.huawei.requests.SetSkinTemperatureMeasurement;
import id.icapps.savera.service.devices.huawei.requests.SetTemperatureUnitSetting;
import id.icapps.savera.service.devices.huawei.requests.StopFindPhoneRequest;
import id.icapps.savera.service.devices.huawei.requests.StopNotificationRequest;
import id.icapps.savera.service.devices.huawei.requests.GetFitnessTotalsRequest;
import id.icapps.savera.service.devices.huawei.requests.GetHiChainRequest;
import id.icapps.savera.service.devices.huawei.requests.GetSleepDataCountRequest;
import id.icapps.savera.service.devices.huawei.requests.GetStepDataCountRequest;
import id.icapps.savera.service.devices.huawei.requests.GetWorkoutCountRequest;
import id.icapps.savera.service.devices.huawei.requests.SendNotificationRequest;
import id.icapps.savera.service.devices.huawei.requests.SetMusicRequest;
import id.icapps.savera.service.devices.huawei.requests.AlarmsRequest;
import id.icapps.savera.service.devices.huawei.requests.DebugRequest;
import id.icapps.savera.service.devices.huawei.requests.GetActivityTypeRequest;
import id.icapps.savera.service.devices.huawei.requests.Request;
import id.icapps.savera.service.devices.huawei.requests.Request.RequestCallback;
import id.icapps.savera.service.devices.huawei.requests.GetAuthRequest;
import id.icapps.savera.service.devices.huawei.requests.GetBatteryLevelRequest;
import id.icapps.savera.service.devices.huawei.requests.GetBondParamsRequest;
import id.icapps.savera.service.devices.huawei.requests.GetBondRequest;
import id.icapps.savera.service.devices.huawei.requests.GetConnectStatusRequest;
import id.icapps.savera.service.devices.huawei.requests.GetDeviceStatusRequest;
import id.icapps.savera.service.devices.huawei.requests.GetDndLiftWristTypeRequest;
import id.icapps.savera.service.devices.huawei.requests.GetExpandCapabilityRequest;
import id.icapps.savera.service.devices.huawei.requests.GetLinkParamsRequest;
import id.icapps.savera.service.devices.huawei.requests.GetPincodeRequest;
import id.icapps.savera.service.devices.huawei.requests.GetProductInformationRequest;
import id.icapps.savera.service.devices.huawei.requests.GetSecurityNegotiationRequest;
import id.icapps.savera.service.devices.huawei.requests.GetSettingRelatedRequest;
import id.icapps.savera.service.devices.huawei.requests.GetSupportedServicesRequest;
import id.icapps.savera.service.devices.huawei.requests.GetWearStatusRequest;
import id.icapps.savera.service.devices.huawei.requests.SendDndAddRequest;
import id.icapps.savera.service.devices.huawei.requests.SendFactoryResetRequest;
import id.icapps.savera.service.devices.huawei.requests.SendFitnessGoalRequest;
import id.icapps.savera.service.devices.huawei.requests.SendMenstrualCapabilityRequest;
import id.icapps.savera.service.devices.huawei.requests.SendDndDeleteRequest;
import id.icapps.savera.service.devices.huawei.requests.SendSetUpDeviceStatusRequest;
import id.icapps.savera.service.devices.huawei.requests.SetActivateOnLiftRequest;
import id.icapps.savera.service.devices.huawei.requests.SetActivityReminderRequest;
import id.icapps.savera.service.devices.huawei.requests.SetDateFormatRequest;
import id.icapps.savera.service.devices.huawei.requests.SetLanguageSettingRequest;
import id.icapps.savera.service.devices.huawei.requests.SetNotificationRequest;
import id.icapps.savera.service.devices.huawei.requests.SetNavigateOnRotateRequest;
import id.icapps.savera.service.devices.huawei.requests.SetTimeRequest;
import id.icapps.savera.service.devices.huawei.requests.SetTimeZoneIdRequest;
import id.icapps.savera.service.devices.huawei.requests.SetTruSleepRequest;
import id.icapps.savera.service.devices.huawei.requests.SetWearLocationRequest;
import id.icapps.savera.service.devices.huawei.requests.SetWearMessagePushRequest;
import id.icapps.savera.service.devices.huawei.requests.GetNotificationCapabilitiesRequest;
import id.icapps.savera.devices.huawei.packets.FitnessData;
import id.icapps.savera.service.devices.huawei.requests.SetWorkModeRequest;
...
public class HuaweiSupportProvider {
    ...
    public id.icapps.savera.service.btle.TransactionBuilder createLeTransactionBuilder(String taskName) {
        return leSupport.createTransactionBuilder(taskName);
    }

    public id.icapps.savera.service.btbr.TransactionBuilder createBrTransactionBuilder(String taskName) {
    ...
    public void performConnected(id.icapps.savera.service.btle.Transaction transaction) throws IOException {
        leSupport.performConnected(transaction);
    }

    public void performConnected(id.icapps.savera.service.btbr.Transaction transaction) throws IOException {
    ...
    protected id.icapps.savera.service.btle.TransactionBuilder initializeDevice(id.icapps.savera.service.btle.TransactionBuilder builder) {
        ...
        builder.add(new id.icapps.savera.service.btle.actions.SetDeviceStateAction(getDevice(), GBDevice.State.AUTHENTICATING, getContext()));
    ...
    protected id.icapps.savera.service.btbr.TransactionBuilder initializeDevice(id.icapps.savera.service.btbr.TransactionBuilder builder) {
        this.gbDevice = brSupport.getDevice();
        this.context = brSupport.getContext();
        this.huaweiType = getCoordinator().getHuaweiType();
        this.paramsProvider.setTransactionsCrypted(this.getHuaweiCoordinator().isTransactionCrypted());
        builder.setCallback(brSupport);
        builder.add(new id.icapps.savera.service.btbr.actions.SetDeviceStateAction(getDevice(), GBDevice.State.AUTHENTICATING, getContext()));
        final GetLinkParamsRequest linkParamsReq = new GetLinkParamsRequest(this, builder);
        initializeDevice(linkParamsReq);
        getCoordinator().setDevice(this.gbDevice);
        return builder;
    ...
    protected void initializeDeviceConfigure() {
        if (isBLE()) {
            id.icapps.savera.service.btle.TransactionBuilder leBuilder = createLeTransactionBuilder("Initializing");
            ...
            leBuilder.add(new id.icapps.savera.service.btle.actions.SetDeviceStateAction(gbDevice, GBDevice.State.INITIALIZING, context));
        } else {
            id.icapps.savera.service.btbr.TransactionBuilder brBuilder = createBrTransactionBuilder("Initializing");
            brBuilder.setCallback(brSupport);
            brBuilder.add(new id.icapps.savera.service.btbr.actions.SetDeviceStateAction(gbDevice, GBDevice.State.INITIALIZING, context));
        }
        try {
            if (firstConnection) {
    ...
    private void fetchActivityData() {
        ...
        if (isBLE()) {
            id.icapps.savera.service.btle.TransactionBuilder leBuilder = createLeTransactionBuilder("FetchRecordedData");
            leBuilder.add(new id.icapps.savera.service.btle.actions.SetDeviceBusyAction(gbDevice, context.getString(R.string.busy_task_fetch_activity_data), context));
            getSleepDataCountRequest = new GetSleepDataCountRequest(this, leBuilder, sleepStart, end);
        } else {
            id.icapps.savera.service.btbr.TransactionBuilder brBuilder = createBrTransactionBuilder("FetchRecordedData");
            brBuilder.add(new id.icapps.savera.service.btbr.actions.SetDeviceBusyAction(gbDevice, context.getString(R.string.busy_task_fetch_activity_data), context));
    ...
    private void fetchWorkoutData() {
        ...
        if (isBLE()) {
            id.icapps.savera.service.btle.TransactionBuilder leBuilder = createLeTransactionBuilder("FetchWorkoutData");
            ...
            id.icapps.savera.service.btbr.TransactionBuilder brBuilder = createBrTransactionBuilder("FetchWorkoutData");
            // TODO: maybe use a different string from the other synchronization
            brBuilder.add(new id.icapps.savera.service.btbr.actions.SetDeviceBusyAction(gbDevice, context.getString(R.string.busy_task_fetch_activity_data), context));
...
//            setWearMessagePushReq.doPerform();
    ...
    public void onSetAlarms(ArrayList<? extends id.icapps.savera.model.Alarm> alarms) {
        ...
        for (id.icapps.savera.model.Alarm alarm : alarms) {
    ...
    public void onUploadProgress(int textRsrc, int progressPercent, boolean ongoing) {
        try {
            if (isBLE()) {
                id.icapps.savera.service.btle.TransactionBuilder leBuilder = createLeTransactionBuilder("FetchRecordedData");
                leBuilder.add(new id.icapps.savera.service.btle.actions.SetProgressAction(
                ...
                id.icapps.savera.service.btbr.TransactionBuilder brBuilder = createBrTransactionBuilder("FetchRecordedData");
                brBuilder.add(new id.icapps.savera.service.btbr.actions.SetProgressAction(
                        context.getString(textRsrc),
                        ongoing,
                        progressPercent,
                        context));
