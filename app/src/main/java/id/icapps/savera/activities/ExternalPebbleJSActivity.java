...
import id.icapps.savera.service.devices.pebble.webview.GBChromeClient;
import id.icapps.savera.service.devices.pebble.webview.GBWebClient;
import id.icapps.savera.service.devices.pebble.webview.JSInterface;
...
public class ExternalPebbleJSActivity extends AbstractGBActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras == null) {
            ...
            if (confUri.getScheme().equals("saverawatch")) {
                try {
