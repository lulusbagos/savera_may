...
public class FindPhoneActivity extends AbstractGBActivity {
    ...
    public static final String ACTION_FOUND = "id.icapps.savera.findphone.action.reply";
    public static final String ACTION_VIBRATE = "id.icapps.savera.findphone.action.vibrate";
    public static final String ACTION_RING = "id.icapps.savera.findphone.action.ring";
