...
public class PeriodicExporter extends BroadcastReceiver {
    ...
    public static final String ACTION_DATABASE_EXPORT_SUCCESS = "id.icapps.savera.action.DATABASE_EXPORT_SUCCESS";
    public static final String ACTION_DATABASE_EXPORT_FAIL = "id.icapps.savera.action.DATABASE_EXPORT_FAIL";
