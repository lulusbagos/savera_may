/*  Copyright (C) 2020 Taavi Eomäe
    ...
    */
package id.icapps.savera.service.devices.nut;
...
import static id.icapps.savera.devices.nut.NutKey.byteArraysConcatReverseWithPad;
import static id.icapps.savera.devices.nut.NutKey.byteArraysDeConcatReverseWithPad;
import static id.icapps.savera.devices.nut.NutKey.bytesToHex2;
import static id.icapps.savera.devices.nut.NutKey.hexStringToByteArrayNut;
import static id.icapps.savera.devices.nut.NutKey.macAsByteArray;
import static id.icapps.savera.devices.nut.NutKey.passwordGeneration;
import static id.icapps.savera.devices.nut.NutKey.reversePasswordGeneration;
