 ...
 */
package id.icapps.savera.daogen;
...
public class GBDaoGenerator {
    ...
    private static final String MAIN_PACKAGE = "id.icapps.savera";
    ...
    private static void addAlarms(Schema schema, Entity user, Entity device) {
        ...
        alarm.implementsInterface("id.icapps.savera.model.Alarm");
    ...
    private static void addReminders(Schema schema, Entity user, Entity device) {
        ...
        reminder.implementsInterface("id.icapps.savera.model.Reminder");
    ...
    private static void addWorldClocks(Schema schema, Entity user, Entity device) {
        ...
        worldClock.implementsInterface("id.icapps.savera.model.WorldClock");
    ...
    private static void addContacts(Schema schema, Entity user, Entity device) {
        ...
        contact.implementsInterface("id.icapps.savera.model.Contact");
